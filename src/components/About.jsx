...
const About = () => {
  return (
    ...
    ' id='About'>
        ...
        About <spam className='underline underline-offset-4 decoration-1 
        under font-light'>Our Brand</spam></h1>
        <p className='text-gray-500 max-w-80 text-center mb-8'>Passionate About Properties, Dedicated to your Vision</p>
        <div className='flex flex-col md:flex-row items-center md:items-start 
        md:gap-20'>
            <img src={assets.brand_img} alt="" className='w-full sm:w-1/2 max-w-lg'  />
            <div className='flex flex-col items-center md:items-start mt-10 text-gray-600'>
                <div className='grid grid-cols-2 gap-2 md:gap-10 w-full 2x1:pr-28'>
                    <div>
                ...
                Accusantium nulla omnis magni. Placeat, officia at. Ipsam id ipsa, 
                ratione enim exercitationem provident corporis sequi inventore sunt obcaecati,
                aspernatur quo esse.</p>
